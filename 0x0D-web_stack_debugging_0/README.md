...
Let’s start with a very simple example. My server must:</p>
- have a copy of the ``/etc/passwd`` file in ``/tmp``
- have a file named ``/tmp/isworking`` containing the string ``OK``

Let's pretend that without these 2 eleements, my web appplication cannot work.
